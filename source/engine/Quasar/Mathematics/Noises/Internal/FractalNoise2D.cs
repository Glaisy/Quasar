//-----------------------------------------------------------------------
// <copyright file="FractalNoise2D.cs" company="Space Development">
...
namespace Quasar.Mathematics.Noises.Internals
{
    ...
    internal sealed class FractalNoise2D : IFractalNoise2D
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FractalNoise2D" /> class.
        /// </summary>
        /// <param name="fractalParameters">The fractal parameters.</param>
        public FractalNoise2D(in FractalParameters fractalParameters)
        {
        ...
        public double Sample(double x, double y)
        {
            ...
            {
                result += a * SimplexNoise.Sample(xf, yf);
